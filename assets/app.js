  ...
  function renderTrack(res) {
    ...
    var html =
      ...
      (perm.isSupply && !perm.canAddProgress
        ? '<div class="alert alert-info small mt">จะบันทึกความก้าวหน้าได้เมื่อคำขอนี้ "อนุมัติแล้ว" (แนบเอกสารอนุมัติและล็อกข้อมูลแล้ว) เป็นต้นไป — ตอนนี้คำขออยู่สถานะ "' + esc(r.Status || '') + '"</div>'
        : '') +
      '</div>';
